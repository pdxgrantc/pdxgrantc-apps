            ...
            <div class="flex flex-col">
                <form>
                    ...
                    <div>
                        ...
                        <input class="text-black w-[50vw] h-[5vh] text-[1.5rem] border-[1.5px] border-black focus:outline-none px-2" type="text" placeholder="List Description" />
                    </div>
                    <div class="h-[1vh]"></div>
                    ...
                    <input type="submit" class="cursor-pointer w-fit text-2xl border-b-[1.5px] on_desktop:hover:bg-button_accent_color on_desktop:hover:ease-[cubic-bezier(0.4, 0, 1, 1)] on_desktop:duration-[350ms] on_desktop:hover:px-[1.25vw] py-[.5vh]" value="Submit"></input>
                </form>
